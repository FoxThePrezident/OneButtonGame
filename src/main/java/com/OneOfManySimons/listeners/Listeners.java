...
public class Listeners {
	...
	public void addRefreshListener(RefreshListener toAdd) {
		if (Debug.listeners.Listeners) System.out.println("--- [Listeners.addListener]");
	...
	public void clearListeners() {
		if (Debug.listeners.Listeners) System.out.println("--- [Listeners.clearListeners]");
	...
	public void callRefreshListeners() {
		if (Debug.listeners.Listeners) System.out.println("--- [Listeners.callListeners]");
